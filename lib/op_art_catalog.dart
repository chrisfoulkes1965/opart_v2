...
final List<OpArtTypes> kOpArtCatalog = [
  OpArtTypes('Flow', OpArtType.Flow, 'lib/assets/flow_200.png'),
  OpArtTypes('Wallpaper', OpArtType.Wallpaper, 'lib/assets/wallpaper_200.png'),
  ...
  OpArtTypes('Triangles', OpArtType.Triangles, 'lib/assets/triangles_200.png'),
  OpArtTypes('Squares', OpArtType.Squares, 'lib/assets/squares_200.png'),
  OpArtTypes('Spirals', OpArtType.Fibonacci, 'lib/assets/fibonacci_200.png'),
  ...
  OpArtTypes('Neighbour', OpArtType.Neighbour, 'lib/assets/neighbour_200.png'),
];
